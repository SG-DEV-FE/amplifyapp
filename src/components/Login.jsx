        ...
        <div>
          ...
          <div className="mt-4">
            <button
              type="button"
              onClick={onStartTour}
              className="w-full flex items-center justify-center px-4 py-3 border-2 border-indigo-600 rounded-md shadow-sm text-sm font-medium text-indigo-600 bg-white hover:bg-indigo-50 transition duration-150 ease-in-out"
            >
              <svg
            ...
            <p className="mt-2 text-center text-xs text-gray-500">
              See what you can do before signing up
            </p>
          </div>
        </div>
